...
- 25dae47: fix(core): `Resource.initial` semea o orzamento inicial (StateStore)
...
- 5e55e2d: fix(core): TreeLayout — separación de múltiples roots en slots lóxicos (7.16b)

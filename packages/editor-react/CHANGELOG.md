...
- 95a28d4: feat(editor-react): «Ver no código» desde o panel Problemas
...
- d0c2228: feat(editor-react): panel «Código» — o JSON en vivo, con cores que explican (7.15b)
...
- 9048328: feat(editor-react): vista de tarxetas no canvas — toggle `grafo | tarxetas` (7.15c)
...
- f04164c: feat(editor-react): «Dispor» — as posicións xa non se inventan (7.16)
...
- c19e95d: feat(editor-react): Ficheiro → Exportar imaxe (SVG/PNG) (7.17)

  Dúas entradas novas no menú Ficheiro (a app fai o I/O, mesma fronteira
  de sempre): SVG autocontido da árbore ENTEIRA encadrada (pan/zoom
  reseteado — determinista, non "o que casualmente vías") e PNG 2x
  rasterizado no navegador. Dispoñibles en Autoría e Proba (en Proba
  exporta cos estados da sesión); en vista tarxetas desactivadas con
  tooltip.
...
- f3effcb: feat(editor-react): «Ir ao nodo» — Estrutura e Problemas navegables
...
- dc5f951: feat(editor-react): botóns de zoom da TopBar operativos (−/+)
...
- c0ed903: feat(editor-react): navegación por teclado nos menús + garda axe do chrome
...
- 1a38ec7: fix(editor-react): o canvas volve entrar en modo Proba (regresión 7.7/7.7c)
...
- 96319b4: fix(editor-react): o SVG do canvas enche o seu panel (non se desborda)
...
- 60554bc: feat(editor-react): atallos de teclado Undo/Redo (Ctrl/Cmd+Z / Ctrl/Cmd+Y)
...
- ec331ed: perf(editor-react): o panel Código sincroniza só o tramo que cambiou

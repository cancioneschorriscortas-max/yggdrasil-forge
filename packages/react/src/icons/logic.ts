// ── INICIO: icons/logic ──
// Iconset Logic — 19 iconos para a semántica de prerequisitos e
// progresión. Arte do dono, iterada en `tools/icon-preview/` e
// promovida a set oficial no 7.19 (Capa 1A: estética por declaración).
//
...
export const LOGIC_ICONS: Readonly<Record<string, IconDef>> = {
  // ── Estados de nodo ─────────────────────────────────────────
